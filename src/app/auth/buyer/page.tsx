          ...
          {mode !== 'FORGOT' && (
            <div className="mb-6">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-2xl border-2 border-slate-200 bg-white hover:bg-slate-50 active:bg-slate-100 text-slate-700 text-sm font-bold shadow-xs hover:shadow transition-all disabled:opacity-50"
              >
                {googleLoading ? (
              ...
              <div className="relative my-6 text-center">
                ...
                <span className="relative bg-white px-3 text-[11px] font-bold text-slate-400 tracking-wider uppercase">
                  या ईमेल से (Or via Email)
                </span>
              </div>
            </div>
          )}
